...
const testimonials = [
  {
    ...
    rating: 5,
    text: "BlueBirdssolutions completely transformed my interview skills. I went from being nervous to confident, and landed my dream job at Microsoft! The mock interviews were incredibly helpful.",
  },
  {
    name: "Arjun Patel",
